...
switch($_GET['page_id']){
	case 'team':
        ...
        $page_details['javascript']['main'] = 'js/pages/TeamDetailPage.js';
	...
	case 'player':
        ...
        $page_details['javascript']['main'] = 'js/pages/PlayerDetailPage.js';
	...
	case 'crime':
        ...
        $page_details['javascript']['main'] = 'js/pages/CrimeDetailPage.js';
	...
	case 'position':
        ...
        $page_details['javascript']['main'] = 'js/pages/PositionDetailPage.js';
        $page_details['show_share_buttons'] = false;
        $page_details['chartsHTML'] = '<div class="four columns top-list">' .
                '<h3>Top Team</h3>' .
                '<div id="teamchart"></div>' .
