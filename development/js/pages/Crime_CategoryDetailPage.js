...
class CrimeCategoryDetailPage extends DetailPage {
    constructor() {
        ...
        tbl.setRenderRowHeaderFn(() => {return '<tr><th class="two columns">Date:</th><th class="two columns">Player:</th><th class="two columns">Crime Sub-Category:</th><th class="one column">Team:</th><th class="five columns">Description:</th></tr>';});
