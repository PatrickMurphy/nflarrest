...
$(e.options.dialog_element).trigger("FilterDialogClosed")
;e.hide()})
...
;$(e.options.dialog_element).trigger("FilterDialogChanged")
...
e.reset()
;$(e.options.dialog_element).trigger("FilterDialogReset")})
...
var e=this.getFilterValues();for(
var t in e){for(
var a in e[t]){
setCookieValue(a,e[t][a])}}}reset(){
...
!i.hasOwnProperty(r))continue
;var n=i[r];if(


Array.isArray(n["type"].default_val)&&n["type"].hasOwnProperty("names")){
var s=0;for(
var o in n["type"].default_val){
setCookieValue(n["type"]["names"][s],n["type"].default_val[s++])}}else{


setCookieValue(r,n["type"].default_val)}}}



e.loadDialogContents()}onFilterChanged(
...
;e.renderView()}countActiveFilters(){
