...
$("#"+this.options.loadingElID).fadeIn()}}class Module{constructor(e,t,a,i){this.setIsInit(true);this.setModuleID(e);this.setParent(t);this.setData(a);this.setOptions(i)}renderView(){console.warn("Default Module renderView Function called.")}setIsInit(e){this.isInit=e===true?true:false}getIsInit(){return this.isInit}setModuleID(e){this.moduleID=e}getModuleID(){


return this.moduleID}setParent(
...
;console.log("data table after render param 1:"+e);if(
!this.getIsInit()){
console.log("data table after render: send event")
;this.parent.Utilities.googleTracking.sendTrackEvent(this.getOption("GoogleTrackingCategory"),"Change Page")}else{
...
i){
var r=this
;i=i===true?true:false;if(
i){
this.setIsInit(i)}


var e=r.displayDataFilterFn||r.defaultFunctions.displayDataFilterFn

;var t=r.displayPaginationTemplateFn||r.defaultFunctions.displayPaginationTemplateFn

;var a=e=>{
r.setData(e)
;r.setupContainerTitle(e)
;var t=r.displayDataCallbackFn||r.defaultFunctions.displayDataCallbackFn
;var a=e=>{
t(e)}

;a(e)
;r.setupPagination(e,i)}



;r.parent.data_controller.getArrests(e,a)}renderCard(
