...
callback:this.displayPaginationTemplateFn||this.defaultFunctions.displayPaginationTemplateFn,afterRender:()=>{if(
...
var b=this.data.length-1;b>=0;b--){
var k=this.data[b];if(
