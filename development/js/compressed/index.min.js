...
n.view_mobile==1){
a.push(n.renderCard(s))}}if(



n.view_mobile==0){

$("#"+n.getOption("targetElement")).html(a.join(""))}else if(
n.view_mobile==1){

$("#"+n.getOption("targetElementMobile")).html(a.join(""))}}
...
;$(t).html('<h4 id="arrest_details_incident_count" style="text-align:left;"># Incidents:</h4>')
...
pageSize:this.view_mobile==0?this.getOption("RowLimit"):5,
pageRange:this.view_mobile==0?2:1})}validateDataFormat(
...
;var e=t.displayDataFilterFn||t.defaultFunctions.displayDataFilterFn

;var a=t.displayPaginationTemplateFn||t.defaultFunctions.displayPaginationTemplateFn

;var i=t.displayDataCallbackFn||t.defaultFunctions.displayDataCallbackFn

;var r=e=>{
t.setData(e)
;t.setupContainerTitle(e)
;i(e)
;t.setupPagination(e)}
...
;v=this.incrementMap(v,k[n])
;f=this.incrementMap(f,k[o])
;_[k[n]]=k[m]}}
