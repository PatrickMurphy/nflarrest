...
var h=Object.keys(a).length-1;h>=0;h--){
var c=a[Object.keys(a)[h]]
;s.push(c)}
...
var E=this.data.length-1;E>=0;E--){
var O=this.data[E];if(
this.dateLimit(O,this.DateRangeControl.getStart(),this.DateRangeControl.getEnd())){
p=this.incrementMap(p,O[n]+O[o])
;A=this.incrementMap(A,O[n])
;g=this.incrementMap(g,O[o])
;M[O[n]]=O[u]}}
