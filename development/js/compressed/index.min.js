...
;n.parent.checkLoadingFinished()
;console.log("run default displayDataCallbackFn")}}setupContainerTitle(
...
;$(a).html(i+e.length+" Incidents:")

;console.log("setup container title end",t,a,i)
;console.log($(t).contents())}setupContainerElements(
...
this.view_mobile){
console.log("setup container elements mobile",this.view_mobile,t)
...
console.log("setup container elements desktop ",this.view_mobile,t,this.getOption("targetElement"))

;$(t).after('<table id="'+this.getOption("targetElement")+'"></table>')
;console.log($(t).html())

;$("#"+this.getOption("targetElement")).after('<div id="pagination-control"></div>')
;console.log($(t).html())}}setupPagination(
