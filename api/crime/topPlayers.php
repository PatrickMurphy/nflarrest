...
$result = $db->query('SELECT Name, count(arrest_stats_id) AS arrest_count FROM `arrest_stats` WHERE Category = \''. $id .'\''. $date_range .' GROUP BY Name ORDER BY arrest_count DESC' . $limit);
