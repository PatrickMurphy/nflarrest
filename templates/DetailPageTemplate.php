...
<body>
    <div class="container">
        ...
        <?php
            ...
            <br class="clear" />
            <section>
                <!--<div class="tweleve columns" id="chart"></div>
            <button id="details_summary_btn" class="button-primary">Expand</button>
			<br class="clear" />-->
                <aside>
                    <?php 
            ...
            <br class="clear" />
            <footer>&copy; 2016 <a href="http://resume.patrickmurphyphoto.com">Patrick Murphy</a> | <a href="http://www.usatoday.com/sports/nfl/arrests/">Data Source</a> | <form action="https://www.paypal.com/cgi-bin/webscr"  class="donate" method="post" target="_top">
...
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
    ...
    <script src="js/DonutChartClass.js"></script>
    <?php 
