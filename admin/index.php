...
<?php
if($_SESSION['auth'] == 1137 || (isset($_POST['username']) && isset($_POST['password']))){
	if($_SESSION['auth'] == 1137 || (strtolower($_POST['username'])=='patrickmurphyphoto' && $_POST['password']== 'DeepSnow2017')){
		$_SESSION['auth'] = 1137;
		require('loggedIn.php');
	}else{
		print '<div style="border:#ff4f4f; background:#ffa5a5;"><b>Error:</b> Incorrect login Details.</div>';
		require('login.php');
	}
}else{
	require('login.php');
...
?>
		...
		<br class="clear" />
		<footer>Made By <a href="http://resume.patrickmurphyphoto.com" title="Want to see my Resume?">Patrick Murphy</a> | <a href="http://nflarrest.com/api/">Open API</a> | <a href="privacypolicy.htm">Privacy Policy</a></footer>
</div>
