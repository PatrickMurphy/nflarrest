...
<div class="row">
	<div class="eight columns">
		...
		<form id="addForm" method="post" action="admin/index.php">
			...
			<label>Team</label>
			<select name="Team"><?php print $team_options; ?></select>
			<label>Name</label>
			...
			<select name="general_category_id"><?php print $crime_options; ?></select>
			<label>Legal Level</label>
			<select name="legal_level_id"><?php print $legal_options; ?></select>
			<label>Outcome Category</label>
			<select name="resolution_category_id"><?php print $outcome_options; ?></select>
			<br />
			<input type="hidden" name="form_action" value="add_arrest" />
			<input type="submit" name="submit" value="Add Arrest" class="button-primary" /> 
			<br />
		</form>
		<div><form id="addForm" method="post" action="admin/index.php">
			<input type="submit" name="form_action" value="Cache SeasonState" /> > <input type="submit" name="form_action" value="Cache Arrests View" /> > <input type="submit" name="form_action" value="Cache Last Arrests" />
			</form>
		</div>
